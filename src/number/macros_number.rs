...
/// based on `u8`, `u16`, `u32`, `u64` and `u128` according to the given
/// parameter.
/// 
...
/// 128-byte big unsigned integer type, and so on. That is, `UU32` is a synonym
/// of `U256`, `UU64` is a synonym of `U512`, and so on.
/// 
...
/// 
/// Furthermore, `UU32`, `UU64`, `UU128`, `UU256`, `UU384`, `UU512`, `UU640`, `UU768`,
/// `UU896`, `UU1024`, and `UU2048` will be also defined to be `U256`, `U512`, 
/// `U1024`, `U2048`, `U3072`, `U4096`, `U5120`, `U6144`, `U7168`, `U8192`, and
/// `U16384`, respectively. `UU32` is 32-byte big unsigned integer type, and `UU64`
/// is 64-byte big unsigned integer type, and `UU128` is 128-byte big unsigned
/// integer type, and so on. That is, `UU32` is a synonym of `U256`, `UU64` is a
