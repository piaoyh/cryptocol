...

{
    ...
    /// cryptographically insecure random numbers by means of
    /// [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)
    /// which is considered to be cryptographically insecure.
    /// 
    /// # Cryptographical Security
    /// The random number generated by this method any() is cryptographically
    /// insecure though this method any() is based on the crate [rand](https://docs.rs/rand/latest/rand/index.html)
    /// (especially, [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)).
    /// 
    /// # Counterpart Methods
    /// - If you want to be sure to use cryptographically insecure pure random
    /// number whose range is from 0 up to BigUInt::max() inclusively, you are
    /// highly encouraged to use the method [any()](struct@BigUInt#method.any)
    /// rather than other methods that generate different ramdom numbers such as
    /// [any_less_than()](struct@BigUInt#method.any_less_than),
    /// [any_odd()](struct@BigUInt#method.any_odd),
    /// [any_odd_less_than()](struct@BigUInt#method.any_odd_less_than)
    /// [any_with_MSB_set()](struct@BigUInt#method.any_with_MSB_set), and
    /// [any_odd_with_MSB_set](struct@BigUInt#method.any_odd_with_MSB_set).
