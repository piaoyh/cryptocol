...
//-============
    ...
    /// let res = a.modular_sub_uint(1_u8, &m);
    /// println!("{} - 1 = {}", a, res);
    /// assert_eq!(res.to_string(), "1");
    /// assert_eq!(res.is_underflow(), false);
    /// ```
    ...
    /// let m = U256::from_string("76801874298166903427690031858186486050853753882811946569946433649006084094").unwrap();
    /// let a = U256::from_uint(2_u8);
    /// let res = a.modular_sub_uint(2_u8, &m);
    /// println!("{} - 2 = {}", a, res);
    /// assert_eq!(res.to_string(), "0");
    /// assert_eq!(res.is_underflow(), false);
    /// ```
    ...
    /// let m = U256::from_string("76801874298166903427690031858186486050853753882811946569946433649006084094").unwrap();
    /// let a = U256::from_uint(2_u8);
    /// let res = a.modular_sub_uint(3_u8, &m);
    /// println!("{} - 3 = {}", a, res);
    ...
    */
    ...
    /// or its behavior may be undefined though it may not panic.
    /// - If `rhs` is zero, it will panic.
    /// - If `modulo` is zero, it will panic.
    /// 
    /// # Features
    /// - It takes the remainder (= `rd1`) of `self` divided by `modulo`,
    /// and takes the remainder (= `rd2`) of `rhs` divided by `modulo`,
    ...
    /// - If `size_of::<T>() * N` <= `128`, this method may panic
    /// or its behavior may be undefined though it may not panic.
    /// - If `modulo` is zero, this method will panic.
    /// 
    /// # Output
    ...
    /// - If `size_of::<T>() * N` <= `128`, this method may panic
    /// or its behavior may be undefined though it may not panic.
    /// - If `rhs` is either zero or one, this method will panic.
    /// 
    /// # Output
