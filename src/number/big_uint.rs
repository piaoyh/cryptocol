...
//        unsafe { copy_nonoverlapping(val.as_ptr() as *const u8, me.number.as_mut_ptr() as *mut u8, USIZE); }
    ...
    /// number whose range is from `0` up to `BigUInt::max()` inclusively for
    /// both ends.
    /// 
    /// # Features
    /// This method basically uses the method `turn_any()` that fills all the
    /// elements of the array `number[T; N]` in struct `BigUInt<T, N>` with the
    /// random numbers cryptographically not secure by means of
    /// [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)
    /// which is considered not to be cryptographically secure. However, if you
    /// use only one random number for cryptographical purpose, you can use the
    /// random variable generated by this method `any()`.
    /// 
    /// # Cryptographical Security
    /// The random number generated by this method `any()` is
    /// cryptographically not secure because this method `any()` is based on the
    /// crate [rand](https://docs.rs/rand/latest/rand/index.html) (especially,
    /// [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)),
    /// which is cryptographically not secure.
    /// 
    /// # Counterpart Methods
    /// - If you want to use random number for cryptographic purpose, you are
    /// highly recommended to use the method [random()](struct@BigUInt#method.random)
    /// rather than this method.
    /// - If you want to use random number less than a certain value, which is
    /// _cryptographically NOT secure_, you are highly recommended to use the
    /// method [any_less_than()](struct@BigUInt#method.any_less_than)
    /// rather than this method.
    /// - If you want to use random odd number which is _cryptographically NOT
    /// secure_, you are highly recommended to use the method [any_odd()](struct@BigUInt#method.any_odd)
    /// rather than this method.
    /// - If you want to use random odd number less than a certain value,
    /// which is _cryptographically NOT secure_, you are highly recommended to
    /// use the method [any_odd_less_than()](struct@BigUInt#method.any_odd_less_than)
    /// rather than this method.
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random number
    /// which is _cryptographically NOT secure_, you are highly recommended to
    /// use the method [any_with_MSB_set()](struct@BigUInt#method.any_with_MSB_set)
    /// rather than this method.
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random odd number
    /// which is _cryptographically NOT secure_, you are highly recommended to
    /// use the method [any_odd_with_MSB_set()](struct@BigUInt#method.any_odd_with_MSB_set)
    /// rather than this method.
    /// 
    /// # Example
    /// ```
    ...
    /// the random variable generated by this method `any_odd()`.
    /// 
    /// # Cryptographical Security
    /// The random number generated by this method `any_odd()` is
    /// cryptographically not secure because this method `any_odd()` is based on
    ...
    // pub fn any_less_than(ceiling: &Self) -> Self
    ...
    /// a pure random number whose range is between `0` and the certain value
    /// inclusively for `0` and exclusively for the certain value.
    /// 
    /// # Features
    /// This method basically uses the method `turn_any()` that fills all the
    /// elements of the array `number[T; N]` in struct `BigUInt<T, N>` with the
    ...
    /// [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)
    /// which is considered not to be cryptographically secure. However, if you
    /// use only one random number less than a certain value for cryptographical
    /// purpose, you can use the random variable generated by this method
    /// `any_less_than()`.
    /// 
    /// # Cryptographical Security
    /// The random number generated by this method `any_less_than()` is
    /// cryptographically not secure because this method `any_less_than()` is
    ...
    pub fn any_less_than(ceiling: &Self) -> Self
    {
        Self::any().wrapping_rem(ceiling)
    }

    // pub fn any_odd_less_than(ceiling: &Self) -> Self
    /// Constucts a new `BigUInt<T, N>`-type object which has the random odd
    /// number less than a certain value.
    /// 
    /// # Output
    /// The random number that this method `random_odd_less_than()` returns is
    /// a pure random odd number whose range is between `1` and the certain
    /// value inclusively for `1` and exclusively for the certain value.
    /// 
    /// # Features
    /// This method basically uses the method `turn_any()` that fills all the
    /// elements of the array `number[T; N]` in struct `BigUInt<T, N>` with the
    ...
    /// [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)
    /// which is considered not to be cryptographically secure. However, if you
    /// use only one random odd number less than a certain value for
    /// cryptographical purpose, you can use the random variable generated by
    /// this method `any_odd_less_than()`.
    /// 
    /// # Cryptographical Security
    /// The random number generated by this method `any_odd_less_than()` is
    /// cryptographically not secure because this method `any_odd_less_than()`
    ...
    /// rather than this method.
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random odd number
    /// which is _cryptographically NOT secure_, you are highly recommended to use
    /// the method [any_odd_with_MSB_set()](struct@BigUInt#method.any_odd_with_MSB_set)
    /// rather than this method.
    /// 
    /// # Example
    /// ```
    ...
    pub fn any_odd_less_than(ceiling: &Self) -> Self
    {
        let mut r = Self::any_less_than(ceiling);
        r.set_LSB();
        r
    }

    // pub fn any_with_MSB_set() -> Self
    /// Constucts a new `BigUInt<T, N>`-type object which has the N * sizeof::<T>() random value
    /// with MSB (Most Significant Bit) is set.
    /// 
    /// # Output
    /// The random number that this method any_with_MSB_set() returns is a
    /// random number whose range is from `!(BigUInt::max() >> 1)` up to
    /// `BigUInt::max()` inclusively for both ends.
    /// 
    /// # Features
    /// This method basically uses the method `turn_any()` that fills all the
    /// elements of the array `number[T; N]` in struct `BigUInt<T, N>` with the
    ...
    /// use the method [any_odd_less_than()](struct@BigUInt#method.any_odd_less_than)
    /// rather than this method.
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random odd
    /// number which is _cryptographically NOT secure_, you are highly
    /// recommended to use the method [any_odd_with_MSB_set()](struct@BigUInt#method.any_odd_with_MSB_set)
    /// rather than this method.
    /// 
    /// # Example
    /// ```
    ...
    // pub fn any_odd_with_MSB_set() -> Self
    /// Constucts a new `BigUInt<T, N>`-type object which has the random odd
    /// value with MSB (Most Significant Bit) is set.
    /// 
    /// # Output
    /// The random number that this method random_odd_with_MSB_set() returns is
    /// a random odd number whose range is from `!(BigUInt::max() >> 1) + 1`
    /// up to `BigUInt::max()` inclusively for both ends.
    /// 
    /// # Features
    /// This method basically uses the method `turn_any()` that fills all the
    /// elements of the array `number[T; N]` in struct `BigUInt<T, N>` with the
    ...
    // pub fn any_prime_using_Miller_Rabin(repetition: usize) -> Self
    ...
    /// 
    /// # Cryptographical Security
    /// The random number generated by this method
    /// `any_prime_using_Miller_Rabin()` is cryptographically not secure
    /// because this method `any_prime_using_Miller_Rabin()` is based on
    /// the crate [rand](https://docs.rs/rand/latest/rand/index.html)
    /// (especially, [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)),
    /// which is cryptographically not secure.
    /// 
    ...
    // pub fn turn_any(&mut self)
    /// Make a `BigUInt<T, N>`-type object to have a random value.
    /// The random number that this method turn_any() makes is a pure random
    /// number whose range is from `0` up to `BigUInt::max()` inclusively.
    /// 
    /// # Features
    /// This method `turn_any()` fills all the elements of the array
    /// `number[T; N]` in struct `BigUInt<T, N>` with the random numbers
    /// cryptographically not secure by means of
    /// [rand::rng::gen<T>()](https://docs.rs/rand/latest/rand/trait.Rng.html#method.gen)
    /// which is considered not to be cryptographically secure. However, if you
    /// use only one random odd number for cryptographical purpose, you can use
    ...
    /// 
    /// # Counterpart Methods
    /// - If you want to use not necessarilly cryptographically secure pure random
    /// number whose range is from `0` up to `BigUInt::max()` inclusively for
    /// both ends, you are highly encouraged to use the method [any()](struct@BigUInt#method.any)
    /// rather than this method.
    /// - If you want to use random number less than a certain value for
    /// cryptographic purpose, you are highly recommended to use the method
    /// [random_less_than()](struct@BigUInt#method.random_less_than)
    ...
    /// rather than this method.
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random number
    /// for cryptographic purpose, you are highly recommended to use the method
    /// [random_with_MSB_set()](struct@BigUInt#method.random_with_MSB_set)
    /// rather than this method.
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random odd
    /// number for cryptographic purpose, you are highly recommended to use the
    /// method [random_odd_with_MSB_set()](struct@BigUInt#method.random_odd_with_MSB_set)
    /// rather than this method.
    /// 
    /// # Example
    /// ```
    ...
    /// 
    /// # Counterpart Methods
    /// - If you want to use random odd number which is not necessarily
    /// cryptographically secure, you are highly recommended to use the method
    /// [any_odd()](struct@BigUInt#method.any_odd) rather than this method.
    /// - If you want to be sure to use cryptographically secure pure random
    /// number whose range is from `0` up to `BigUInt::max()` inclusively for
    /// both ends, you are highly encouraged to use the method [random()](struct@BigUInt#method.random)
    /// rather than this method.
    /// - If you want to use random number less than a certain value for
    /// cryptographic purpose, you are highly recommended to use the method
    /// [random_less_than()](struct@BigUInt#method.random_less_than)
    ...
    /// # Counterpart Methods
    /// - If you want to use random number less than a certain value, which is
    /// not necessarily cryptographically secure, you are highly recommended to
    /// use the method [any_less_than()](struct@BigUInt#method.any_odd) rather than this method.
    /// - If you want to be sure to use cryptographically secure pure random
    /// number whose range is from `0` up to `BigUInt::max()` inclusively for
    /// both ends, you are highly encouraged to use the method [random()](struct@BigUInt#method.random)
    /// rather than this method.
    ...
    /// 
    /// # Counterpart Methods
    /// - If you want to use random odd number less than a certain value, which
    /// is not necessarily cryptographically secure, you are highly recommended
    /// to use the method [any_odd_less_than()](struct@BigUInt#method.any_odd_less_than)
    /// rather than this method.
    /// - If you want to be sure to use cryptographically secure pure random
    /// number whose range is from `0` up to `BigUInt::max()` inclusively for
    /// both ends, you are highly encouraged to use the method [random()](struct@BigUInt#method.random)
    ...
    /// # Counterpart Methods
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random number,
    /// which is not necessarily cryptographically secure, you are highly
    /// recommended to use the method [any_with_MSB_set()](struct@BigUInt#method.any_with_MSB_set)
    /// rather than this method.
    /// - If you want to be sure to use cryptographically secure pure random
    /// number whose range is from `0` up to `BigUInt::max()` inclusively for
    /// both ends, you are highly encouraged to use the method [random()](struct@BigUInt#method.random)
    ...
    /// # Counterpart Methods
    /// - If you want to use `(N * sizeof::<T>() * 8)`-bit long random odd
    /// number, which is not necessarily cryptographically secure, you are
    /// highly recommended to use the method [any_odd_with_MSB_set()](struct@BigUInt#method.any_with_MSB_set)
    /// rather than this method.
    /// - If you want to be sure to use cryptographically secure pure random
    /// number whose range is from `0` up to `BigUInt::max()` inclusively for
    /// both ends, you are highly encouraged to use the method [random()](struct@BigUInt#method.random)
    ...
    /// 
    /// # Counterpart Methods
    /// - If you want to use random prime number which is not necessarily
    /// cryptographically secure, you are highly recommended to use the method
    /// [any_prime_using_Miller_Rabin()](struct@BigUInt#method.any_prime_using_Miller_Rabin)
    /// rather than this method.
    /// 
    /// # Example
    /// ```
    ...
    pub fn get_lower_portion(&self, portion: usize) -> Self
    {
        ...
        else if portion < available
        {
            ...
            let piece_num = portion % TSIZE_IN_BITS;
            if piece_num != 0
            {
    ...
    /// a.set_uint(169743176821145534028236692093846345739_u128);
    /// if a.is_MSB_set()
    ///     { println!("{} is greater than halfmax ({}).", a, Self::halfmax()); }
    /// else
    ///     { println!("{} is less than or equal to halfmax ({}).", a, Self::halfmax()); }
    /// assert!(!a.is_MSB_set());
    /// 
    /// a <<= 1;
    /// if a.is_MSB_set()
