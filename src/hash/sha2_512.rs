...
pub type SHA2_Generic_512_KRS_fixed<const H0: u64, const H1: u64, const H2: u64,
                                    const H3: u64, const H4: u64, const H5: u64,
                                    const H6: u64, const H7: u64,
                                    const ROUND: usize, const N: usize>
    // Initialize array of round constants: based on the first sixty-four bits of 
    // the fractional parts of the cube roots of the first eighty prime numbers
    = SHA2_Generic_512< 0x428a2f98d728ae22, 0x7137449123ef65cd, 0xb5c0fbcfec4d3b2f, 0xe9b5dba58189dbbc, 0x3956c25bf348b538, 
                        ...
                        1, 8, 14, 18, 19, 28, 34, 39, 41, 61, 6, 7, ROUND, N>;

/// H0 ~ H7 are The first 32 bits of the fractional parts of the square roots
/// of the first 8 primes 2..19
#[allow(non_camel_case_types)]
pub type SHA2_Generic_512_HRS_fixed<const K00: u64, const K01: u64, const K02: u64, const K03: u64,
                    ...
                    const ROUND: usize, const N: usize>
    = SHA2_Generic_512< K00, K01, K02, K03, K04, K05, K06, K07,
...
/// of the first 8 primes 2..19
#[allow(non_camel_case_types)]
pub type SHA2_512_Expanded<const ROUND: usize, const N: usize>
    = SHA2_Generic_512_KRS_fixed<0x6a09e667f3bcc908, 0xbb67ae8584caa73b, 0x3c6ef372fe94f82b,
                                0xa54ff53a5f1d36f1, 0x510e527fade682d1, 0x9b05688c2b3e6c1f,
                                0x1f83d9abfb41bd6b, 0x5be0cd19137e2179, ROUND, N>;

/// H0 ~ H7 are the second 32 bits of the fractional parts of the square roots
/// of the 9th through 16th primes 23..53
#[allow(non_camel_case_types)]
pub type SHA2_384_Expanded<const ROUND: usize, const N: usize>
                                // H0 ~ H7 are the second 32 bits of the fractional
                                // parts of the square roots of the 9th through
                                // 16th primes 23..53
    = SHA2_Generic_512_KRS_fixed<0xcbbb9d5dc1059ed8, 0x629a292a367cd507, 0x9159015a3070dd17,
                                0x152fecd8f70e5939, 0x67332667ffc00b31, 0x8eb44a8768581511,
                                0xdb0c2e0d64f98fa7, 0x47b5481dbefa4fa4, ROUND, N>;

#[allow(non_camel_case_types)]
pub type SHA2_512 = SHA2_512_Expanded<80, 8>;

#[allow(non_camel_case_types)]
pub type SHA2_384 = SHA2_384_Expanded<80, 6>;

#[allow(non_camel_case_types)]
pub type SHA2_512_256 = SHA2_Generic_512_KRS_fixed<0x22312194FC2BF72C, 0x9F555FA3C84C64C2,
...
// #[allow(non_camel_case_types)]
// pub type SHA2_512_224 = SHA2_Generic_512_KRS_fixed<0x8C3D37C819544DA2, 0x73E1996689DCD4D6,
...
/// length into a 512-bit hash value or 384-bit hash value, and its flexible
/// variants that allows you to develop your own
/// `SHA-2-512`-based hash algorithms
/// 
/// # Introduction
...
#[derive(Debug, Clone)]
#[allow(non_camel_case_types)]
pub struct SHA2_Generic_512<const K00: u64, const K01: u64, const K02: u64, const K03: u64,
                            const K04: u64, const K05: u64, const K06: u64, const K07: u64,
                            const K08: u64, const K09: u64, const K10: u64, const K11: u64,
                            const K12: u64, const K13: u64, const K14: u64, const K15: u64,
                            const K16: u64, const K17: u64, const K18: u64, const K19: u64,
...
SHA2_Generic_512<K00, K01, K02, K03, K04, K05, K06, K07,
                ...
                RR39, RR41, RR61, SR6, SR7, ROUND, N>
{
...
impl<const K00: u64, const K01: u64, const K02: u64, const K03: u64,
    ...
    const RR41: u32, const RR61: u32, const SR6: i32, const SR7: i32,
    const ROUND: usize, const N: usize>
Display for SHA2_Generic_512<K00, K01, K02, K03, K04, K05, K06, K07,
                            K08, K09, K10, K11, K12, K13, K14, K15,
                            K16, K17, K18, K19, K20, K21, K22, K23,
                            K24, K25, K26, K27, K28, K29, K30, K31,
                            K32, K33, K34, K35, K36, K37, K38, K39,
